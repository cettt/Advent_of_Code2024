---
title: "<a href = 'https://adventofcode.com/2021'> Advent of Code 2024 </a>"
...
For Day 16 I used the [collections](https://cran.r-project.org/web/packages/collections/index.html) library which provides high performance container types (in particular priority queues). 
...
print(readRDS("Output/AoC2024_results.RDS"))
```
